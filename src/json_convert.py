...
df_merged_options = df_merged.groupby(['faction', 'name', 'unit_type', 'wargear', 'base_points', 'inc_bow_count', 'siege_crew', 'quantity', 'pointsPerUnit', 'pointsTotal', 'warband_size'])\
