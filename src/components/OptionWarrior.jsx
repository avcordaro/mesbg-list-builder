              ...
              newUnit.options = newUnit.options.map((_option) => {
                ...
                if (newOption.option_id === option.option_id) {
                  ...
                  newUnit["pointsPerUnit"] =
                    newUnit["pointsPerUnit"] - option.points;
                  newUnit["pointsTotal"] =
                    newUnit["pointsPerUnit"] * newUnit["quantity"];
                  if (
                    newUnit["default_bow"] === false &&
                    ...
                    newWarband["bow_count"] =
                      newWarband["bow_count"] - newUnit["quantity"];
                    newRoster["bow_count"] =
                      newRoster["bow_count"] - newUnit["quantity"];
                  }
                  newWarband["points"] =
                    newWarband["points"] + newUnit["pointsTotal"];
                  newRoster["points"] =
          ...
          if (newUnit.id === unit.id) {
            newUnit.options = newUnit.options.map((_option) => {
              ...
              if (
                ...
                includeSameType(newOption.type, option.type)
              ) {
                newRoster["points"] =
                  newRoster["points"] - newUnit["pointsTotal"];
                newWarband["points"] =
          ...
          if (newUnit.id === unit.id) {
            newUnit.options = newUnit.options.map((_option) => {
              ...
              if (newOption.option_id === option.option_id) {
                ...
                newUnit["pointsPerUnit"] =
                  newUnit["pointsPerUnit"] -
                  option.points * option.opt_quantity;
                newUnit["pointsPerUnit"] =
                  newUnit["pointsPerUnit"] + option.points * newQuantity;
