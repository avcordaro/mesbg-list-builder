    ...
    <Stack direction="horizontal" gap={3} className="ms-3">
      <Stack direction="horizontal">
        ...
        <Button
          ...
          disabled={casualtyCount === 0}
        >
          <FaChevronLeft />
        </Button>
        <h5 className="m-0" style={{ width: "40px", textAlign: "center" }}>
          <b>{casualtyCount + heroCasualtyCount}</b>
        </h5>
        <Button
          variant="secondary"
          size="sm"
          ...
          disabled={
            casualtyCount >=
            roster.num_units -
              Object.values(gameHeroes).reduce((val, x) => val + x.length, 0)
          }
        >
          <FaChevronRight />
        </Button>
    ...
    <div>
      ...
      <div style={{ marginLeft: "535px", minWidth: "720px" }}>
        <Stack direction="horizontal" style={{ minWidth: "800px" }}>
          <Button className="m-2" onClick={() => setShowResetModal(true)}>
            <TbRefresh /> Reset All
          </Button>
          <GameModeCasualties
            casualtyCount={casualtyCount}
