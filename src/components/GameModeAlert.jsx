...
export function GameModeAlert({gameModeAlert, setGameModeAlert, setRoster}) {
  ...
  >
    ...
    <hr/>
    Sorry, but your army list contains outdated data. This can
    happen when importing a list built using an older version of the application.
    Game Mode is only supported for army lists built in <b>v5.0.0</b> or later.
    You will need to reset your list and rebuild it in order to use Game Mode.
    <hr/>
    <div className="mt-2 d-flex justify-content-end">
      <Button className="me-3" onClick={() => setGameModeAlert(false)} variant="secondary">
        Nevermind
      </Button>
